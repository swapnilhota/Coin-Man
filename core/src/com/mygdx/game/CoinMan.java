...
public class CoinMan extends ApplicationAdapter {
	...
	ArrayList<com.badlogic.gdx.math.Rectangle> coinRect = new ArrayList<com.badlogic.gdx.math.Rectangle>();
	int coinCount;

	Texture bomb;
	ArrayList<Integer> bombYs = new ArrayList<Integer>();
	ArrayList<Integer> bombXs = new ArrayList<Integer>();
	ArrayList<com.badlogic.gdx.math.Rectangle> bombRect = new ArrayList<com.badlogic.gdx.math.Rectangle>();
	int bombCount;
	...
	public void render () {
		...
		if(gameState == 1)
		{
			...
			for(int i=0; i<bombXs.size(); i++)
			{
				...
				bombRect.add(new com.badlogic.gdx.math.Rectangle(bombXs.get(i), bombYs.get(i), bomb.getWidth(), bomb.getHeight()));
			}
			...
			for(int i=0; i<coinXs.size(); i++)
			{
				...
				coinRect.add(new com.badlogic.gdx.math.Rectangle(coinXs.get(i), coinYs.get(i), coin.getWidth(), coin.getHeight()));
			}
